		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#hesapdokumucari-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hesapdokumucari-display": {
								"semanticObject": "hesapdokumucari",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hesapdokumu.cari",
									"url": sap.ui.require.toUrl("hesapdokumu/cari")
								}
							}
						}
					}
